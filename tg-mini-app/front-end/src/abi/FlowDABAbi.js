export const FlowDabContract = {
    address: "0xf80e25CC37582CE8B2653af3AD93f902cF333C87", // Morph
    ...
    abi: [
        ...
        },
        {
            type: 'function',
            name: 'getTopProjects',
            inputs: [{ name: '_noOfProjects', type: 'uint256', internalType: 'uint256' }],
            outputs: [
                {
                    name: '',
                    type: 'tuple[]',
        ...
        },
        {
            ...
            outputs: [
                ...
                { name: 'destinationChainAddress', type: 'address', internalType: 'address' },
                { name: 'sourceMailbox', type: 'address', internalType: 'address' }
            ],
            stateMutability: 'view'
        },
        {
        ...
        },
        {
            ...
            inputs: [
                { name: '_destinationChainId', type: 'uint32', internalType: 'uint32' },
                { name: '_destinationChainAddress', type: 'address', internalType: 'address' },
                { name: '_sourceMailboxAddress', type: 'address', internalType: 'address' }
            ],
            outputs: [],
            stateMutability: 'nonpayable'
        },
        {
            ...
            inputs: [{ name: '_destinationChainId', type: 'uint256', internalType: 'uint256' }],
            outputs: [],
            stateMutability: 'nonpayable'
        },
        {
